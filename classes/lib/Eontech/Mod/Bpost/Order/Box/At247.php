...
class EontechModBpostOrderBoxAt247 extends EontechModBpostOrderBoxNational
{
	/**
	 * @var string
	 */
	 ...
	 * @return EontechModBpostOrderBoxAt247
	 * @throws EontechModException
	 */
	public static function createFromXML(\SimpleXMLElement $xml)
	{
		...
		if (isset($xml->{'at24-7'}->parcelsDepotAddress))
		{
			...
			$at247->setParcelsDepotaddress(EontechModBpostOrderParcelsDepotAddress::createFromXML($parcels_depot_address_data));
		}
