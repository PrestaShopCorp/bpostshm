...
class TijsVerkoyenBpostBpostOrderBoxOptionSrgInsured extends TijsVerkoyenBpostBpostOrderBoxOption
{
	/**
	 * @var string
	 */
	...
	public static function createFromXML(\SimpleXMLElement $xml)
	{
		...
		if (1 === $value)
			return new TijsVerkoyenBpostBpostOrderBoxOptionSrgInsured('basicInsurance');
		else
			return new TijsVerkoyenBpostBpostOrderBoxOptionSrgInsured('additionalInsurance', $value);
